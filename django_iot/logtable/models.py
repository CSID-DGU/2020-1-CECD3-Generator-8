...
class Level(models.Model):
   ...
   # building_id = models.ForeignKey('Building', on_delete=models.CASCADE,default = uuid.uuid4)
...
class Sensor(models.Model):
    ...
    sensor_status=models.CharField(max_length=2, choices=STATUS_CHOICES, default='ND', unique = True)
